...
#import <VerizonAdsVerizonNativeController/VASVerizonNativeComponentBundle.h>
...
/// Required args: kVASComponentArgsAdSessionKey, kVASNativeComponentDelegateRefKey
...
/// A set of strings representing the required components for this bundle, if available, otherwise nil.
@property (readonly, nullable) NSSet<NSString *> *requiredComponentIds;
...
@property (readonly, nullable) OMIDVerizonmediaMediaEvents *omVideoEvents;
