...
+ (void)sendVASTUrlsWithId:(NSArray<VASVASTUrlWithId *> *)vastUrls usingSession:(NSURLSession *)session;
+ (void)sendTrackingRequest:(NSURL *)trackingURL usingSession:(NSURLSession *)session;
