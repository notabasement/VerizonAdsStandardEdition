...
#import <VerizonAdsNativePlacement/VASNativeAdErrors.h>
...
/**
 Called when an error occurs during the VASNativeAd lifecycle. A VASErrorInfo object provides detail about the error.
...
/**
 Called when the VASNativeAd causes the user to leave the application. For example, tapping a VASNativeAd may launch an external browser.
