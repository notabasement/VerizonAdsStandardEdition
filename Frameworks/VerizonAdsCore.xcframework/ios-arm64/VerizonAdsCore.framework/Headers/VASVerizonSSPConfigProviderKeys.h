...
FOUNDATION_EXPORT NSString * const kVASNativeAdComponentsTimeoutKey;
...
FOUNDATION_EXPORT NSString * const kVASEnableBackgroundAdRequestKey;
...
FOUNDATION_EXPORT NSString * const kVASCacheReplenishmentThresholdKey;
