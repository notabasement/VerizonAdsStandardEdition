...
// Authorization Tracking State (ATTrackingManager.trackingAuthorizationStatus, by introspection)
extern NSString * const kVASAppTrackingStateNotDetermined;
extern NSString * const kVASAppTrackingStateRestricted;
extern NSString * const kVASAppTrackingStateDenied;
extern NSString * const kVASAppTrackingStateAuthorized;
...
/// Specifies the value of NSAllowsArbitraryLoadsInWebContent if set (returns "NO" if not set).
@property (class, readonly, getter=allowArbitraryLoadsInWeb) BOOL allowArbitraryLoadsInWeb;
...
/// Indicates status of ad tracking authorization.
@property (class, readonly) NSString *trackingAuthorizationState;
...
/// Indicates whether the Authorization Tracking State (status) of the app is ATTrackingManagerAuthorizationStatusAuthorized. (Internal use only, not sent in requests.)
@property (class, readonly) BOOL isTrackingAuthorized;
