...
extern NSString * const kVASAppAuthInfoKey;
extern NSString * const kVASAppTrackingStateKey;    // NSString based on ATTrackingManager.trackingAuthorizationStatus
extern NSString * const kVASAppTrackingOverrideKey; // NSString, based on VASConfiguration kDomainVASCore kVASConfigPublisherTrackingAuthorizationOverrideKey

extern NSString * const kVASResponseAuthInfoVersion1; // Value containing authorization info version 1.0 Type: id<NSString>
extern NSString * const kVASResponseAuthInfoVersion2; // Value containing authorization info version 2.0 Type: id<NSString>
